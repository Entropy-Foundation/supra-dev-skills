...
echo ""
echo "3. Create an account profile:"
echo "   supra key generate --key-type ed25519 --profile myAccount"
echo ""
echo "4. Fund your account (testnet — also creates the account on-chain):"
echo "   supra move account fund-with-faucet --profile myAccount --rpc-url https://rpc-testnet.supra.com"
echo ""
echo "5. Deploy your contract:"
echo "   supra move tool publish --package-dir "/supra/move_workspace/myProject" --profile myAccount --rpc-url https://rpc-testnet.supra.com"
echo ""
